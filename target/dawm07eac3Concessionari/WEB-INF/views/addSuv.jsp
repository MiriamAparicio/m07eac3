    ...
    <body>
        ...
        <section class="container">
            <form:form modelAttribute="newModel" class="form-horizontal">
                <fieldset>
                    <legend>Afegir cotxe Suv</legend>
                    ...
                    <div class="form-group">
                        <label class="control-label col-lg-2 col-lg-2" for="cavalls">Cavalls</label>
                        <div class="col-lg-10">
                            <form:input id="cavalls" path="cavalls" type="text" class="form:input-large"/>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-lg-2 col-lg-2" for="consum">Consum</label>
                        <div class="col-lg-10">
                            <form:input id="consum" path="consum" type="text" class="form:input-large"/>
                        </div>
                    </div>
                    <div class="form-group">

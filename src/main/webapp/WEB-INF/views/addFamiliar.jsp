    ...
    <body>
        ...
        <section class="container">
            <form:form modelAttribute="newModel" class="form-horizontal">
                <fieldset>
                    <legend>Afegir cotxe Familiar</legend>
                    ...
                    <div class="form-group">
                        <label class="control-label col-lg-2 col-lg-2" for="numPlaces">Número de places</label>
                        <div class="col-lg-10">
                            <form:input id="numPlaces" path="numPlaces" type="text" class="form:input-large"/>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-lg-2 col-lg-2" for="midaMaleter">Volum del maleter</label>
                        <div class="col-lg-10">
                            <form:input id="midaMaleter" path="midaMaleter" type="text" class="form:input-large"/>
                        </div>
                    </div>
                    <div class="form-group">
